...
[**CopyAndPasteEnum.bat**](https://github.com/frizb/Windows-Privilege-Escalation/blob/master/CopyAndPasteEnum.bat)
...
[**enumeration.md** ](https://github.com/frizb/Windows-Privilege-Escalation/blob/master/enumeration.md)

Basic notes on Windows Enumeration from the OSCP.

[**windows_recon.bat**](https://github.com/frizb/Windows-Privilege-Escalation/blob/master/windows_recon.bat)
